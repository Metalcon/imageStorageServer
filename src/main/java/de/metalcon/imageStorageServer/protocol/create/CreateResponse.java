...
public class CreateResponse extends Response {
    ...
    public void imageIdentifierMissing() {
        parameterMissing(ProtocolConstants.Parameters.Create.IMAGE_IDENTIFIER,
    ...
    public void imageStreamMissing() {
        parameterMissing(ProtocolConstants.Parameters.Create.IMAGE_STREAM,
    ...
    public void
        cropLeftCoordinateInvalid(final int left, final String solution) {
        addStatusMessage(
